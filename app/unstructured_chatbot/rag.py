...
Environment:
    ...
    PINECONE_UNSTRUCTURED_INDEX (default index name if not provided to class)
...
from app.unstructured_chatbot.embeddings import embed_texts, embed_text
...
DEFAULT_INDEX = Settings.PINECONE_UNSTRUCTURED_INDEX
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            index_name: Pinecone index name (defaults to PINECONE_UNSTRUCTURED_INDEX env)
        ...
        if not self.index_name:
            raise RuntimeError("Index name not provided. Set PINECONE_UNSTRUCTURED_INDEX or pass index_name=...")
